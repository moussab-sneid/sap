...
<html>
<head>
<title>Sapco | Admin Changer Mot de passe</title>
...
{
alert(" Nouveau mot de passe et Confirmer le mot de passe ne correspondent pas  !!");
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Accueil</a><i class="fa fa-angle-right"></i>Profile <i class="fa fa-angle-right"></i> Changer Mot de passe</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
